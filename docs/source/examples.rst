...
To calculate MAC\ :sub:`BC` of a lognormal black carbon size distribution, use the :py:func:`shape2abs_SD` function. This example shows a partially collapsed black carbon size distribution with geometric mean volume-equivalent diameter of 250nm and M\ :sub:`tot`/M\ :sub:`BC` of 10 :math:`{\pm}`2, calculated at 532 nm.
