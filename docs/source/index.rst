...
Online user's guide for the Python Black Carbon Absorption package (pyBCabsorption)
======================================================================
...
Install pyBCabsorption
------------------

The current version is 0.0.1. You can install pyBCabsorption from `The Python Package Index (PyPI) <https://pypi.python.org/pypi/pyBCabsorption>`_ with ::
...
--------------------------
pyBCabsorption was written by `Payton Beeler <https://scholar.google.com/citations?user=8Td-XI4AAAAJ&hl=en&oi=ao/>`_.

Email: `beelerpayton@wustl.edu <mailto:beelerpayton@wustl.edu?subject=pyBCabsorption>`_
